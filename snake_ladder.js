...
var boxArr=[],
    ...
    fries.src = './fries.png';
    pizza.src = './pizza.png';
    Pulses.src = './Pulses.png';
    vegetables.src = './vegetables.jpg';



canvas.width=WIDTH;
canvas.height=HEIGHT;
canvasPlayer.width=400;
...
function loadSnakeAndLadder(){
    ...
    _canvasObj.DrawImageWH(cake1,boxSize*1, boxSize*4,60, 60);
    _canvasObj.DrawImageWH(snake2,boxSize*1, 0,230,400);
    _canvasObj.DrawImageWH(burger,boxSize*1, 0,60, 60);
    _canvasObj.DrawImageWH(snake3,boxSize*5,boxSize*2,150,250);
    _canvasObj.DrawImageWH(pizza,boxSize*5,boxSize*2,50,50);
    _canvasObj.DrawImageWH(snake4,boxSize*6,0,100,200);
    _canvasObj.DrawImageWH(fries,boxSize*6,2,70,50);
    _canvasObj.Save();
    _canvasObj.Rotate(0.25);
    _canvasObj.DrawImageWH(ladder1,boxSize*7, boxSize*3, 30,200);
    _canvasObj.Restore();
    _canvasObj.Save();
    _canvasObj.Rotate(-0.20);
    _canvasObj.DrawImageWH(ladder2,boxSize*7,boxSize*3,30,320);
    _canvasObj.Restore();
    _canvasObj.Save();
    _canvasObj.Rotate(-0.2);
    _canvasObj.DrawImageWH(egg,boxSize*7,boxSize*6.5,70,70);  
    _canvasObj.Rotate(0.3);
    _canvasObj.DrawImageWH(ladder3,boxSize*4, boxSize*7, 30,170);
    _canvasObj.Restore();
    _canvasObj.DrawImageWH(milk,boxSize*3,9,70,50);
    _canvasObj.DrawImageWH(vegetables,boxSize*5,boxSize*7,70,60);
    _canvasObj.DrawImageWH(Pulses,boxSize*3,boxSize*9,70,0);
